                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <textarea placeholder="Enter Details" id="ctrl-details"  required="" rows="5" name="details" class=" form-control"><?php  echo $this->set_field_value('details',""); ?></textarea>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="expense_date">Expense Date <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-expense_date" class="form-control datepicker  datepicker" required="" value="<?php  echo $this->set_field_value('expense_date',""); ?>" type="datetime"  name="expense_date" placeholder="Enter Expense Date" data-enable-time="true" data-min-date="" data-max-date="" data-date-format="Y-m-d H:i:S" data-alt-format="F j, Y - H:i" data-inline="false" data-no-calendar="false" data-mode="single" /> 
