                        ...
                        <form id="categories-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("categories/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="category_name">Category Name <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-category_name"  value="<?php  echo $this->set_field_value('category_name',""); ?>" type="text" placeholder="Enter Category Name"  required="" name="category_name"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
