                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-category_name"  value="<?php  echo $data['category_name']; ?>" type="text" placeholder="Enter Category Name"  required="" name="category_name"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
