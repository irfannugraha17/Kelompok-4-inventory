                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-pay"> Pay</th>
                                                <th  class="td-due"> Due</th>
                                                <th  class="td-payBy"> Payby</th>
                                                <th  class="td-order_date"> Order Date</th>
                                                <th  class="td-order_month"> Order Month</th>
                                                <th  class="td-order_year"> Order Year</th>
