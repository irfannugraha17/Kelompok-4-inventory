...
class CustomersController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				customers.address LIKE ? OR 
				customers.photo LIKE ? OR 
				customers.created_at LIKE ? OR 
				customers.updated_at LIKE ?
			)";
			$search_params = array(
		...
		$this->render_view("customers/list.php", $data); //render the full page
	}
	/**
     * View record detail 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","email","phone","address","photo","created_at","updated_at");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","email","phone","address","photo","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'name' => 'required',
