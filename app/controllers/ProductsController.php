...
class ProductsController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				products.id LIKE ? OR 
				products.category_id LIKE ? OR 
				products.supplier_id LIKE ? OR 
				products.product_name LIKE ? OR 
				products.product_code LIKE ? OR 
				products.root LIKE ? OR 
				products.buying_price LIKE ? OR 
				products.selling_price LIKE ? OR 
				products.buying_date LIKE ? OR 
				products.image LIKE ? OR 
				products.product_quantity LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("category_id","supplier_id","product_name","product_code","root","buying_price","selling_price","buying_date","image","product_quantity","created_at","updated_at");
			...
			$this->sanitize_array = array(
				...
				'root' => 'sanitize_string',
				'buying_price' => 'sanitize_string',
				'selling_price' => 'sanitize_string',
				'buying_date' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","category_id","supplier_id","product_name","product_code","root","buying_price","selling_price","buying_date","image","product_quantity","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'category_id' => 'required|numeric',
