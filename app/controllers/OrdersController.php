...
class OrdersController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				orders.id LIKE ? OR 
				orders.customer_id LIKE ? OR 
				orders.qty LIKE ? OR 
				orders.sub_total LIKE ? OR 
				orders.vat LIKE ? OR 
				orders.total LIKE ? OR 
				orders.pay LIKE ? OR 
				orders.due LIKE ? OR 
				orders.payBy LIKE ? OR 
				orders.order_date LIKE ? OR 
				orders.order_month LIKE ? OR 
				orders.order_year LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("customer_id","qty","sub_total","vat","total","pay","due","payBy","order_date","order_month","order_year","created_at","updated_at");
			...
			$this->sanitize_array = array(
				...
				'pay' => 'sanitize_string',
				'due' => 'sanitize_string',
				'payBy' => 'sanitize_string',
				'order_date' => 'sanitize_string',
				'order_month' => 'sanitize_string',
				'order_year' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","customer_id","qty","sub_total","vat","total","pay","due","payBy","order_date","order_month","order_year","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'customer_id' => 'required|numeric',
