...
class ExpensesController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				expenses.id LIKE ? OR 
				expenses.details LIKE ? OR 
				expenses.amount LIKE ? OR 
				expenses.expense_date LIKE ? OR 
				expenses.created_at LIKE ? OR 
				expenses.updated_at LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("details","amount","expense_date","created_at","updated_at");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","details","amount","expense_date","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'details' => 'required',
